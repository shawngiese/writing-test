...
Where do I answer?::
In the xref:modules/ROOT/pages/challenge-1.adoc[] file, in the "Answer" section.
...
* link:mailto:julie.legendre@magnolia-cms.com[Julie]
* link:mailto:ashraf.khamis@magnolia-cms.com[Ashraf]
* link:mailto:martin.drapela@magnolia-cms.com[Martin]
* link:mailto:alex.mansell@magnolia-cms.com[Alex]
